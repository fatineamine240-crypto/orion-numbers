...
export default function Button({
  ...
  const defaultClass =
    'px-6 pb-2 pt-2.5 inline-block max-w-full rounded text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out focus:outline-none shadow hover:shadow-lg focus:shadow-lg active:shadow-lg';
